...
# contracts, registrations and balances are all present. See docs/FORK.md.
#
# =============================================================================
...
# Produce a fork bundle by biting production previewnet.
...
bite: build-spawner ensure-binaries
	@node $(CURDIR)/bin/ppn.mjs bite "$(FORK_DIR)"
...
help:
	...
	@echo "  bite                   Bite production into a fork bundle (no start)"
