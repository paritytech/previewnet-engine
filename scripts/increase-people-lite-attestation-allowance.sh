...
# What it used to decide now lives in `ppn service increase-people-lite-attestation-allowance` — see docs/ARCHITECTURE.md.
...
exec node "$ENTRY" service increase-people-lite-attestation-allowance
